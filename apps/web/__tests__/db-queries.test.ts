...
vi.mock("@orchester/db", () => ({
  ...
  schema: {
    ...
    agents: { workspaceId: "workspaceId", status: "status", teamId: "teamId", createdAt: "createdAt" },
    employees: { workspaceId: "workspaceId", active: "active" },
    conversations: { workspaceId: "workspaceId", startedAt: "startedAt", status: "status", durationSeconds: "durationSeconds" },

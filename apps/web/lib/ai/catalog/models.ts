...
export const MODELS: ModelDef[] = [
  ...
  m("together", "meta-llama/Llama-3.3-70B-Instruct-Turbo", "Llama 3.3 70B (Together)", "chat", { tier: "smart", ctx: 131_072 }),
  m("together", "deepseek-ai/DeepSeek-V3", "DeepSeek V3 (Together)", "chat", { tier: "smart", ctx: 131_072 }),
  m("fireworks", "accounts/fireworks/models/llama-v3p3-70b-instruct", "Llama 3.3 70B (Fireworks)", "chat", { tier: "smart", ctx: 131_072 }),
  ...
  m("openrouter", "anthropic/claude-sonnet-4.5", "Claude Sonnet 4.5 (OpenRouter)", "chat", { tier: "smart", ctx: 200_000 }),
  m("openrouter", "google/gemini-2.5-pro", "Gemini 2.5 Pro (OpenRouter)", "chat", { tier: "powerful", ctx: 1_000_000 }),
  m("openrouter", "meta-llama/llama-3.3-70b-instruct", "Llama 3.3 70B (OpenRouter)", "chat", { tier: "smart", ctx: 131_072 }),
  ...
  m("sambanova", "Meta-Llama-3.3-70B-Instruct", "Llama 3.3 70B (SambaNova)", "chat", { tier: "fast", ctx: 131_072 }),
  m("deepinfra", "meta-llama/Llama-3.3-70B-Instruct", "Llama 3.3 70B (DeepInfra)", "chat", { tier: "smart", ctx: 131_072 }),
  m("cohere", "command-a-03-2025", "Command A", "chat", { tier: "smart", ctx: 256_000 }),
  m("nvidia", "meta/llama-3.3-70b-instruct", "Llama 3.3 70B (NVIDIA)", "chat", { tier: "smart", ctx: 131_072 }),
  ...
  m("google", "imagen-4.0-generate-001", "Imagen 4", "image", { tier: "powerful" }),
  m("google", "gemini-2.5-flash-image", "Gemini 2.5 Flash Image (Nano Banana)", "image", { tier: "smart" }),
  m("google", "gemini-3-pro-image-preview", "Gemini 3 Pro Image (Nano Banana Pro)", "image", { tier: "powerful" }),
  ...
  m("replicate", "black-forest-labs/flux-1.1-pro", "FLUX 1.1 Pro (Replicate)", "image", { tier: "powerful" }),
  m("replicate", "ideogram-ai/ideogram-v3-turbo", "Ideogram v3 Turbo (Replicate)", "image", { tier: "smart" }),
  ...
  // ── Video (catálogo) ───────────────────────────────────────────────────────────
  m("google_veo", "veo-3", "Veo 3", "video"),

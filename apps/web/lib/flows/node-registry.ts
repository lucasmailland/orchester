  ...
  integration: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "json",
        advanced: true,
        help: "Retries when the action fails. Retries repeat the action: make sure it is safe to repeat.",
  ...
  http: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "boolean",
        advanced: true,
        help: "Fail the step when the final response is not 2xx",
      },
      {
        key: "retry",
        label: "Reintentos",
        type: "json",
        advanced: true,
        help: "Retries network errors, 429 and 5xx. Replaces maxAttempts when set. Retries repeat the request: make sure it is safe to repeat.",
        example: '{ "attempts": 3, "backoffMs": 1000, "maxBackoffMs": 30000 }',
      },
    ],
    defaults: { method: "GET" },
